...
class BenefitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create benefit" do
    assert_difference('Benefit.count') do
      post benefits_url, params: { benefit: { description: @benefit.description, solution_id: @benefit.solution_id, validated: @benefit.validated } }
    end
  ...
  test "should update benefit" do
    patch benefit_url(@benefit), params: { benefit: { description: @benefit.description, solution_id: @benefit.solution_id, validated: @benefit.validated } }
